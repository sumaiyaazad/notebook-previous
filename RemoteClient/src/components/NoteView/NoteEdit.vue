          ...
          ...mapActions({
            ...
            deleteAction(){
              ...
              if(this.$route.params.id!='0'){
                ...
                this.axios.post('https://obscure-falls-77670.herokuapp.com:443/deletenote', {
            ...
            saveAction(){
              ...
              if(this.$route.params.id==='0'){
                ...
                this.axios.post('https://obscure-falls-77670.herokuapp.com:443/newnote', {
                  username: this.$store.getters.username,
                  password: this.$store.getters.password,
                  text: this.text
                }).then(function (response) {
                ...
                this.axios.post('https://obscure-falls-77670.herokuapp.com:443/editnote', {
                  username: this.$store.getters.username,
                  password: this.$store.getters.password,
                  _id: this.$route.params.id,
                  text: this.text
